 ...
 *  2024/7/24 15:11
 */
public class ConfigInfoBetaMapperByPostgresql extends BasePostgreMapper implements ConfigInfoBetaMapper {
    ...
    public MapperResult findAllConfigInfoBetaForDumpAllFetchRows(MapperContext context) {
        ...
        String sql = " SELECT t.id,data_id,group_id,tenant_id,app_name,content,md5,gmt_modified,beta_ips,encrypted_data_key "
                + " FROM ( " +getLimitPageSql("SELECT id FROM config_info_beta  ORDER BY id ",startRow,pageSize)
                + " )"
