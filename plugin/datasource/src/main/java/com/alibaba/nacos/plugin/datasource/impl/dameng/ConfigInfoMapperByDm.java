...
/**
 * *The dameng implementation of ConfigInfoMapperByDm.
...
public class ConfigInfoMapperByDm extends AbstractDmMapper implements ConfigInfoMapper {
	...
	public MapperResult findAllConfigKey(MapperContext context) {
		String sql =
				...
				+ buildPaginationSql("SELECT id FROM config_info WHERE tenant_id LIKE ? ORDER BY id",context.getStartRow()  ,
	...
	public MapperResult findAllConfigInfoBaseFetchRows(MapperContext context) {
		String sql = "SELECT t.id,data_id,group_id,content,md5"
				+ " FROM ( "+buildPaginationSql("SELECT id FROM config_info ORDER BY id" , context.getStartRow() ,
				 context.getPageSize()) + " )" + " g, config_info t  WHERE g.id = t.id ";
		return new MapperResult(sql, Collections.emptyList());
	}
	...
	public MapperResult listGroupKeyMd5ByPageFetchRows(MapperContext context) {
		String sql = "SELECT t.id,data_id,group_id,tenant_id,app_name,md5,type,gmt_modified,encrypted_data_key FROM "
				+ "(  "+ buildPaginationSql("SELECT id FROM config_info ORDER BY id", context.getStartRow(),context.getPageSize())
	...
	public MapperResult findConfigInfoBaseLikeFetchRows(MapperContext context) {
		...
		return new MapperResult(buildPaginationSql(sql , context.getStartRow() , context.getPageSize()),
				paramList);
	}
	...
	public MapperResult findConfigInfoBaseByGroupFetchRows(MapperContext context) {
		String sql = findConfigInfoBaseByGroupFetchRows(context.getStartRow(),context.getPageSize());
				//"SELECT id,data_id,group_id,content FROM config_info WHERE group_id=? AND tenant_id=?" + " LIMIT "
	...
	public MapperResult findConfigInfoLike4PageFetchRows(MapperContext context) {
		...
		return new MapperResult(buildPaginationSql(sqlFetchRows + where, context.getStartRow() , context.getPageSize()),
				paramList);
	}
	...
	public MapperResult findAllConfigInfoFetchRows(MapperContext context) {
		String sql = "SELECT t.id,data_id,group_id,tenant_id,app_name,content,md5 "
				+ " FROM ( "
				+ buildPaginationSql("SELECT id FROM config_info WHERE tenant_id LIKE ? ORDER BY id",context.getStartRow(),context.getPageSize())
				+" )"
				+ " g, config_info t  WHERE g.id = t.id ";
