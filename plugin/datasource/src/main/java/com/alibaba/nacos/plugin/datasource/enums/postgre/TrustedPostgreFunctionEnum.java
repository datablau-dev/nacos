...
package com.alibaba.nacos.plugin.datasource.enums.postgre;
 ...
 * @author blake.qiu
 */
public enum TrustedPostgreFunctionEnum {
    ...
    static {
        for (TrustedPostgreFunctionEnum entry : TrustedPostgreFunctionEnum.values()) {
    ...
    TrustedPostgreFunctionEnum(String functionName, String function) {
    ...
    public static String getFunctionByName(String functionName) {
        TrustedPostgreFunctionEnum entry = LOOKUP_MAP.get(functionName);
        if (entry != null) {
